    ...
    updateBasicInfo(pid, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existEmail = yield this.userModel.findOne({ email: data.email });
                if (existEmail) {
                    return new response_1.default(false, 400, 'Email already exists', undefined);
                }
                const existPhone = yield this.userModel.findOne({ phone: data.phoneNo });
                if (existPhone) {
                    return new response_1.default(false, 400, 'Phone already exists', undefined);
                }
                if (data.firstName) {
                    user.firstName = data.firstName;
                }
