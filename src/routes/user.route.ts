...
route.patch('/password/:id',passportJwt,validator(updatePassword),UserController.updatePassword)
route.patch('/phone-verify/:id',passportJwt,validator(updatePhoneVerify),UserController.updatePhoneVerify)
route.patch('/email-verify/:id',passportJwt,validator(updateEmailVerify),UserController.updateEmailVerify)
