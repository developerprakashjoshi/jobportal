    ...
    delete(pid, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                role.deletedAt = (0, moment_1.default)().toDate(); // Set the deleted_at field to the current timestamp
                role.deleteBy = data.deleteBy;
                role.deleteFrom = data.ip;
