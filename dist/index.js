...
const recruiter_route_1 = __importDefault(require("@routes/recruiter.route"));
const apply_route_1 = __importDefault(require("@routes/apply.route"));
...
app.use('/api/v1/recruiter', recruiter_route_1.default);
app.use('/api/v1/apply', apply_route_1.default);
app.get("/", (req, res) => {
    res.status(200).json({
        success: true,
        statusCode: 200,
