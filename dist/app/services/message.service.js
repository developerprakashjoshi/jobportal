...
class MessageService extends service_1.default {
    constructor() {
        super();
        this.messageModel = mongoose_1.default.model('Message');
    }
    count() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.messageModel.count({ deleted_at: { $eq: null } });
    ...
    list() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this.messageModel.find();
    ...
    retrieve(pid) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const record = yield this.messageModel.findById(pid).populate('sender', 'firstName lastName').populate('recipient', 'firstName lastName');
                if (!record) {
                    return new response_1.default(false, 200, "Record not found");
                }
                return new response_1.default(true, 200, "Read operation successful", record);
            }
            catch (error) {
    ...
    retrieveByMessage(name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const records = yield this.messageModel.findOne({ where: { name: name } });
                return records;
            }
            catch (error) {
                return error;
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let message = new message_schema_1.default();
    ...
    update(pid, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let id = new mongodb_1.ObjectId(pid);
                const message = yield this.messageModel.findById(pid);
                if (!message) {
    ...
    delete(pid, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const message = yield this.messageModel.findById(pid);
                if (!message) {
                    return new response_1.default(true, 404, "Message not found", message);
                }
                message.deletedAt = (0, moment_1.default)().toDate(); // Set the deleted_at field to the current timestamp
                message.deleteBy = data.deleteBy;
                message.deleteFrom = data.ip;
                const result = yield message.save(message);
                return new response_1.default(true, 200, "Delete operation successful", message);
            }
            catch (error) {
                return new response_1.default(false, 400, error.message);
            }
